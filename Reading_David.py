...
#importing our functions for predictions and demoing the models on their own datasets
from Predictions_ModelTests import EMNIST_predict
from Predictions_ModelTests import MathCNN_predict
from Predictions_ModelTests import MathMLP_predict
...
while True:
    ...
    # cv2.destroyAllWindows()
        ...
        prediction= EMNIST_predict (resized_cropped, EMNIST_model, images_height, images_width)    
        # prediction= MathCNN_predict (resized_cropped, math_CNN_model, images_height, images_width)
        # prediction= MathMLP_predict (resized_cropped, math_MLP_model, images_height, images_width)
        alltext.append(prediction)
