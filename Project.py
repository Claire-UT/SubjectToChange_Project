...
#STEP 1: In the kernal use pip install emnist AND pip install tensorflow (will take A Second.... took me like 30 mins)
...
y1 = tf.keras.utils.to_categorical(train_images, number_of_classes)
y2 = tf.keras.utils.to_categorical(test_images, number_of_classes)
